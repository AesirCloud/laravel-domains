...
class MakeDomainCommand extends Command
{
    ...
    public function handle()
    {
        ...
        // Create Domain Directories in app/Domains/<DomainName>
        ...
        // Create Domain Stub Files (Entity, Repository Interface, DomainService)
        ...
        // Create Base Model (if missing) and Domain Model in app/Models
        ...
        // Create CRUD Actions in app/Actions/{{ domain }}
    ...
    protected function createFile($destination, $contents)
    {
        ...
        // If file exists, and we're not forcing, confirm.
