...
2. Create Value Objects - Value objects are generated separately to represent specific domain concepts.
   Run the command:
   ```php
...
3. Extending an Existing Domain:
